...
<div class="container">
 ...
 <ul class="nav navbar-nav navbar">
         <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Bed Allotment <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
             
              <li class="divider"></li>
              <li><li>  <?php echo anchor('reception/reception_bedallotment', 'Bed Allotment'); ?></li></li>
            <li class="divider"></li>
              <li><li>  <?php echo anchor('reception/reception_bedallotment_list', 'Bed Allotment List'); ?></li></li>
