...
echo form_open('pharmacy/pharmacy_submit');
?>
  <table align="center">
...
<td width="400px">
      ...
      &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <input type="text" name ="pharmacycategory" required >
	 
</td>

</tr>
 <tr><td colspan="2"><p> &nbsp; &nbsp; &nbsp;</p></td></tr>
   <tr rowspan="2"><td align="center" colspan="2" ><input type="submit" value="Save Madicine Category" ></td></tr>
</table>
<?php echo form_close();
