...
echo form_open('pharmacy/pharmacy_generic_submit');
?>
  <table align="center">
    <tr>
<td width="400px">
...
<td width="400px">
      ...
      &nbsp; &nbsp;  &nbsp; &nbsp; <input type="text" name ="madicinegeneric" required >
	 
</td>

</tr>
 <tr><td colspan="2"><p> &nbsp; &nbsp; &nbsp;</p></td></tr>
   <tr rowspan="2"><td align="center" colspan="2" ><input type="submit" value="Save Madicine Generic" ></td></tr>
</table>
<?php echo form_close();
